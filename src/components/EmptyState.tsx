...
const features = [
  { icon: <FileSearch className="w-5 h-5" />, title: "Smart Summaries", desc: "Instant key-point extraction" },
  { icon: <MessageSquareText className="w-5 h-5" />, title: "Document Chat", desc: "Ask anything about your PDF" },
  { icon: <BarChart3 className="w-5 h-5" />, title: "Visual Insights", desc: "Auto-generated diagrams" },
];
...
const EmptyState = ({ onFileSelect }: EmptyStateProps) => (
  <div className="flex-1 flex flex-col items-center justify-center p-8">
    ...
    >
      ...
      {/* Upload */}
      <PDFUploadZone onFileSelect={onFileSelect} uploadedFile={null} onRemoveFile={() => {}} />
      ...
      <div className="grid grid-cols-3 gap-3">
        {features.map((f, i) => (
          <motion.div
            ...
            className="text-center p-4 rounded-xl bg-secondary/30 border border-border"
          >
