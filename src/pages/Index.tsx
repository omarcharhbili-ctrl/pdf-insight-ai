    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        {!activeSession ? (
          ...
          <>
            {/* Top Bar */}
            <header className="flex items-center justify-between px-5 py-3 border-b border-border shrink-0 bg-card/50">
            ...
            {activeTab === "chat" && (
              <div className="flex-1 flex flex-col min-h-0">
                ...
                <div className="px-6 pb-4 pt-2 shrink-0 max-w-3xl w-full mx-auto">
